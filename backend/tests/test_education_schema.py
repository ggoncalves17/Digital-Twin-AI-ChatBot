...
from digital_twin.schemas.education import (
    EducationBase,
    EducationLevel,
    EducationUpdate,
)
...
def test_update_occupation_schema():
    ...
    assert education_update.level is None 
    assert education_update.school is None
    assert education_update.date_started is None
    assert education_update.date_finished is None
    assert education_update.is_graduated is None
    assert education_update.grade is None
